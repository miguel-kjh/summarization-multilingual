...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_name_or_path",
        type=str,
        default="models/BSC-LT/salamandra-2b-instruct/spanish/lora/salamandra-2b-instruct-spanish-e1-b2-lr0.0002-wd0.01-c8192-peft-lora-r16-a32-d0.0-2025-06-05-15-03-26",

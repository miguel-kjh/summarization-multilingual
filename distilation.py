...
def save_model_connector(model: pl.LightningModule, folder: str, name_model: str = "connector.pth"):
    ...
    torch.save(connector.state_dict(), os.path.join(folder, name_model))
...
def main(args: dict):
    ...
    # TODO: improve prepare_embeddings to generate embeddings for al text
    ...
    save_model_connector(model, args.output_dir, f"connector_{args.run_name}.pth")
